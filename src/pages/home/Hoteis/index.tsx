                  ...
                  <DestinyContent>
                    <label>
                      ...
                      <InputContainerC>
                        <input
                          type="text"
                          placeholder="Cidade, Regiao.. ponto de referencia"
                        />
                      </InputContainerC>
                    </label>
                  </DestinyContent>
        ...
        <RecomendedHotels>
          <SwiperContainer>
            <ContentContainer>
              <Hotelv2>
                <div>
                  <ImgContentReal></ImgContentReal>
                </div>
              </Hotelv2>
              <TitleContainerHotel>
                <OverLabel>
                  <HotelDescription>Américas Granada Hotel</HotelDescription>
                </OverLabel>
                <StarContainer>
            ...
            <ContentContainer>
              ...
              <PriceHotel>
                <PrecoReal>
                  <TituloContent>R$ R$ 2.100</TituloContent>
                  <ButtonContentContainer>ver mais</ButtonContentContainer>
                </PrecoReal>
              </PriceHotel>
            </ContentContainer>
